        ...
        <header class="header">
            ...
            <nav class="container container--pall flex flex-jc-sb flex-ai-c">
                <a href="/" class="header__logo">
                    <img src="{{ asset('assets/logo.svg') }}" alt="Easybank" />
                </a>
                ...
                <div class="feature__grid">
                    <div class="feature__item">
                        <div class="feature__icon">
                            <img src="{{ asset('assets/icon-online.svg') }}" />
                        </div>
                    ...
                    <div class="feature__item">
                        <div class="feature__icon">
                            <img src="{{ asset('assets/icon-budgeting.svg') }}" />
                        </div>
                    ...
                    <div class="feature__item">
                        <div class="feature__icon">
                            <img src="{{ asset('assets/icon-onboarding.svg') }}" />
                        </div>
                    ...
                    <div class="feature__item">
                        <div class="feature__icon"><img src="{{ asset('assets/icon-api.svg') }}" /></div>
            ...
            <div class="article__content container container--pall">
                ...
                <div class="article__grid">
                    <a href="#" class="article__item">
                        <div class="article__image" style="background-image: url('/assets/image-currency.jpg')"
                        ></div>
                    ...
                    <a href="#" class="article__item">
                        ...
                        style="background-image: url({{ URL::asset('/assets/image-restaurant.jpg') }})"
                        ></div>
                        <div class="article__text">
                    ...
                    <a href="#" class="article__item">
                        <div
                        class="article__image"
                        style="background-image: url({{ URL::asset('/assets/image-plane.jpg') }})"
                        ></div>
                        <div class="article__text">
                            <div class="article__author">By Wilson Hutton</div>
                            <div class="article__title">
                    ...
                    <a href="#" class="article__item">
                        <div
                        class="article__image"
                        style="background-image: url({{ URL::asset('/assets/image-confetti.jpg') }})"
                        ></div>
                        <div class="article__text">
                            <div class="article__author">By Claire Robinson</div>
                            <div class="article__title">
